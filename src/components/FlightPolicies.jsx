        ...
        {[
          {
            ...
            label: "Changes",
            value:
              "Date changes allowed up to 24h before departure (fee may apply).",
          },
          {
            icon: ShieldCheck,
            label: "Cancellation",
          ...
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-transparent bg-linear-to-br from-[#4076bd] to-[#1e3a5f]">
